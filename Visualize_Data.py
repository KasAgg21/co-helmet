...
def update(frame):
    global alert_played
    co_level, helmet_worn = generate_dummy_data()
...
def generate_dummy_data():
    co_level = random.randint(0, 1024)  # Random CO level between 0 and 1024
    helmet_worn = random.choice([True, False])  # Randomly choose if the helmet is worn
    return co_level, helmet_worn
